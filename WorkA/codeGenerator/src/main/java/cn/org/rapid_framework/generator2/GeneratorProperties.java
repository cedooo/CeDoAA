...
import cn.org.rapid_framework.generator2.util.PropertiesHelper;
import cn.org.rapid_framework.generator2.util.PropertyPlaceholderHelper;
import cn.org.rapid_framework.generator2.util.PropertyPlaceholderHelper.PropertyPlaceholderConfigurerResolver;
...
public class GeneratorProperties {
	...
	public static void reload() {
		try {
			cn.org.rapid_framework.generator2.util.GLogger.println("Start Load GeneratorPropeties from classpath:"+Arrays.toString(PROPERTIES_FILE_NAMES));
			Properties p = new Properties();
			String[] loadedFiles = PropertiesHelper.loadAllPropertiesFromClassLoader(p,PROPERTIES_FILE_NAMES);
			cn.org.rapid_framework.generator2.util.GLogger.println("GeneratorPropeties Load Success,files:"+Arrays.toString(loadedFiles));
			setProperties(p);
		}catch(IOException e) {
...
//            }
	...
	public static void setProperty(String key,String value) {
	    ...
	    cn.org.rapid_framework.generator2.util.GLogger.println("[setProperty()] "+key+"="+value);
	...
	public static void setProperties(Properties inputProps) {
        ...
        for(Iterator it = props.entrySet().iterator();it.hasNext();) {
            ...
            cn.org.rapid_framework.generator2.util.GLogger.println("[Property] "+entry.getKey()+"="+entry.getValue());
        }
        cn.org.rapid_framework.generator2.util.GLogger.println("");
        
        cn.org.rapid_framework.generator2.util.GLogger.println("[Auto Replace] [.] => [/] on generator.properties, key=source_key+'_dir', For example: pkg=com.company ==> pkg_dir=com/company  \n");
