...
public class Table {
	...
	public static String removeTableSqlNamePrefix(String sqlName) {
		String prefixs = cn.org.rapid_framework.generator2.GeneratorProperties.getProperty("tableRemovePrefixes", "");
   ...
   public Column getRequiredColumnBySqlName(String sqlName) {
	 ...
	 */
	public cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys getExportedKeys() {
		if (exportedKeys == null) {
			exportedKeys = new cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys(this);
		}
		return exportedKeys;
	}
	/**
	 ...
	 */
	public cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys getImportedKeys() {
		if (importedKeys == null) {
			importedKeys = new cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys(this);
		}
		return importedKeys;
	}
	...
	private cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys exportedKeys;
	private cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKeys importedKeys;
