package cn.org.rapid_framework.generator2.provider.db.table.model;



import java.util.List;

import cn.org.rapid_framework.generator2.provider.db.table.model.ForeignKey.ReferenceKey;
import cn.org.rapid_framework.generator2.util.StringHelper;
import cn.org.rapid_framework.generator2.util.TestDataGenerator;
import cn.org.rapid_framework.generator2.util.typemapping.ActionScriptDataTypesUtils;
import cn.org.rapid_framework.generator2.util.typemapping.DatabaseDataTypesUtils;
...
public class Column {
	 ...
	 */
	private cn.org.rapid_framework.generator2.provider.db.table.model.Table _table;
	 ...
	 * @param remarks
	 */
	public Column(cn.org.rapid_framework.generator2.provider.db.table.model.Table table, int sqlType, String sqlTypeName,
		...
		cn.org.rapid_framework.generator2.util.GLogger.trace(sqlName + " isPk -> " + _isPk);
	 ...
	 */
	public cn.org.rapid_framework.generator2.provider.db.table.model.Table getTable() {
		return _table;
	}
	...
	public String getNoRequiredValidateString() {
		return cn.org.rapid_framework.generator2.provider.db.table.model.util.ColumnHelper.getRapidValidation(this);
	}
	...
	public String[] getHibernateValidatorConstraintNames() {
		return cn.org.rapid_framework.generator2.provider.db.table.model.util.ColumnHelper.removeHibernateValidatorSpecialTags(getHibernateValidatorExprssion());
	}
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
	...
	private void initOtherProperties() {
		...
		javaType = cn.org.rapid_framework.generator2.GeneratorProperties.getProperty("java_typemapping."+normalJdbcJavaType,normalJdbcJavaType).trim();
		...
		setHibernateValidatorExprssion(cn.org.rapid_framework.generator2.provider.db.table.model.util.ColumnHelper.getHibernateValidatorExpression(this));
	}
