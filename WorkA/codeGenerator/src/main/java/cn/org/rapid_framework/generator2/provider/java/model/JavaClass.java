...
public class JavaClass {
	...
	public cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] getMethods() {
		return toJavaMethods(clazz.getDeclaredMethods());
	}
	
	public cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] getPublicMethods() {
		Method[] methods = clazz.getDeclaredMethods();
		return toJavaMethods(filterByModifiers(methods,Modifier.PUBLIC));
	}

	public cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] getPublicStaticMethods() {
		Method[] methods = clazz.getDeclaredMethods();
		return toJavaMethods(filterByModifiers(methods,Modifier.PUBLIC,Modifier.STATIC));
	}

	public cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] getPublicNotStaticMethods() {
	...
	public cn.org.rapid_framework.generator2.provider.java.model.JavaProperty[] getProperties() throws Exception {
		List<cn.org.rapid_framework.generator2.provider.java.model.JavaProperty> result = new ArrayList<cn.org.rapid_framework.generator2.provider.java.model.JavaProperty>();
		BeanInfo beanInfo = Introspector.getBeanInfo(clazz);
		PropertyDescriptor[] pds = beanInfo.getPropertyDescriptors();
		for(PropertyDescriptor pd : pds) {
			result.add(new cn.org.rapid_framework.generator2.provider.java.model.JavaProperty(pd,this));
		}
		return (cn.org.rapid_framework.generator2.provider.java.model.JavaProperty[])result.toArray(new cn.org.rapid_framework.generator2.provider.java.model.JavaProperty[0]);
	}
	
	public List<cn.org.rapid_framework.generator2.provider.java.model.JavaField> getFields() {
		Field[] fields = clazz.getDeclaredFields();
		List result = new ArrayList();
		for(Field f : fields) {
			result.add(new cn.org.rapid_framework.generator2.provider.java.model.JavaField(f,this));
		}
		return result;
	}
	...
	public cn.org.rapid_framework.generator2.provider.java.model.JavaField getField(String name) throws NoSuchFieldException,SecurityException {
		return new cn.org.rapid_framework.generator2.provider.java.model.JavaField(clazz.getField(name),this);
	}
	...
	private cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] toJavaMethods(Method[] declaredMethods) {
		cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[] methods = new cn.org.rapid_framework.generator2.provider.java.model.JavaMethod[declaredMethods.length];
		for(int i = 0; i < declaredMethods.length; i++) {
			methods[i] = new cn.org.rapid_framework.generator2.provider.java.model.JavaMethod(declaredMethods[i],this);
		}
		return methods;
	}
