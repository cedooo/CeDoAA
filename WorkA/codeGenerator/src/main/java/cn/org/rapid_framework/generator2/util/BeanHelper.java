...
public class BeanHelper {
		...
		for(int i = 0; i < descriptors.length; i++ ) {
			...
			if (readMethod != null) {
				try {
					...
					cn.org.rapid_framework.generator2.util.GLogger.warn("error get property value,name:"+name+" on bean:"+obj,e);
				}
            }
		}
		return map;
    ...
    private static Object convert(String value,Class<?> targetType) {
        ...
        if(cn.org.rapid_framework.generator2.util.DateHelper.isDateType(targetType)) {
            return cn.org.rapid_framework.generator2.util.DateHelper.parseDate(value,targetType,"yyyyMMdd","yyyy-MM-dd","yyyyMMddHHmmSS","yyyy-MM-dd HH:mm:ss","HH:mm:ss");
        }
