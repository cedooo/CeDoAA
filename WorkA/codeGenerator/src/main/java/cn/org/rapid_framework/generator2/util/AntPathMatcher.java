...
public class AntPathMatcher  {
	...
	private boolean matchStrings(String pattern, String str, Map<String, String> uriTemplateVariables) {
		cn.org.rapid_framework.generator2.util.AntPathStringMatcher matcher = new cn.org.rapid_framework.generator2.util.AntPathStringMatcher(pattern, str, uriTemplateVariables);
