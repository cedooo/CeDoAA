package cn.org.rapid_framework.generator2.provider.db.sql.model;
 ...
 * </pre>
 * 
 * @see cn.org.rapid_framework.generator2.provider.db.sql.SqlFactory
 * @author badqiu
 *
 */
public class Sql {
	...
	LinkedHashSet<cn.org.rapid_framework.generator2.provider.db.table.model.Column> columns = new LinkedHashSet<cn.org.rapid_framework.generator2.provider.db.table.model.Column>();
	...
	public boolean isColumnsInSameTable() {
		...
		for(cn.org.rapid_framework.generator2.provider.db.table.model.Column c :columns) {
			cn.org.rapid_framework.generator2.provider.db.table.model.Table table = c.getTable();
			if(table == null) {
				return false;
			}
	...
	public void addColumn(cn.org.rapid_framework.generator2.provider.db.table.model.Column c) {
		columns.add(c);
	}
	/**
	 ...
	 * @return
	 */
	public LinkedHashSet<cn.org.rapid_framework.generator2.provider.db.table.model.Column> getColumns() {
		return columns;
	}
	public void setColumns(LinkedHashSet<cn.org.rapid_framework.generator2.provider.db.table.model.Column> columns) {
...
//	}
    ...
    private String joinColumnsSqlName() {
		...
		for(Iterator<cn.org.rapid_framework.generator2.provider.db.table.model.Column> it = columns.iterator(); it.hasNext();) {
			cn.org.rapid_framework.generator2.provider.db.table.model.Column c = it.next();
	...
	public String getTableClassName() {
		...
		String removedPrefixSqlName = cn.org.rapid_framework.generator2.provider.db.table.model.Table.removeTableSqlNamePrefix(tableSqlName);
		return StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(removedPrefixSqlName));
	}

	public cn.org.rapid_framework.generator2.provider.db.table.model.Column getColumnBySqlName(String sqlName) {
		for(cn.org.rapid_framework.generator2.provider.db.table.model.Column c : getColumns()) {
	...
	public cn.org.rapid_framework.generator2.provider.db.table.model.Column getColumnByName(String name) {
	    cn.org.rapid_framework.generator2.provider.db.table.model.Column c = getColumnBySqlName(name);
	    if(c == null) {
